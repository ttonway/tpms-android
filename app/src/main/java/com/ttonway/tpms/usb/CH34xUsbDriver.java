 ...
 */
public class CH34xUsbDriver extends TpmsDriver {
    private static final String TAG = CH34xUsbDriver.class.getSimpleName();
    ...
    public CH34xUsbDriver(Context context, DriverCallback callback) {
        super(context, callback);
        TpmsApp.driver1 = new CH34xUARTDriver(
                (UsbManager) context.getSystemService(Context.USB_SERVICE), context.getApplicationContext(),
                ACTION_USB_PERMISSION);
        this.mDriver = TpmsApp.driver1;
    }
