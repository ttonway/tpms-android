...
public class FlowRadioGroup extends RadioGroup {
    ...
    String getMeasureSpecModeDesc(int mode) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d(TAG, "onMeasure " + getMeasureSpecModeDesc(modeWidth) + "-" + sizeWidth + "  " + getMeasureSpecModeDesc(modeHeight) + "-" + sizeHeight);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (modeWidth != MeasureSpec.UNSPECIFIED && lineWidth + childWidth > sizeWidth - getPaddingLeft() - getPaddingRight()) {
